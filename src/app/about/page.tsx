      ...
      <div className="flex flex-col md:flex-row pb-10">
        <div className="flex-2 flex items-center justify-start pl-5 tracking-wider">
          <p className="font-semibold text-lg leading-relaxed">
            ...
            website which would allow users to test their knowledge of
            Overwatch. This project was intialized, planned, and executed within
            a ten week period, primarily using the React library. If you have
            any questions or comments, please contact us with the information
            given below.
          </p>
        </div>
