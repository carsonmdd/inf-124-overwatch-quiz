...
const ANSWER_CLASSES = {
    default:  'border-ow-blue/50 bg-ow-blue/10 hover:bg-ow-light-blue/10 hover:border-ow-light-blue/45 cursor-pointer',
...
const LETTER_CLASSES = {
    default:  'bg-ow-blue/40 text-white/45 group-hover:bg-ow-light-blue/20 group-hover:text-ow-light-blue',
...
const QuizClient = ({ questions }: Props) => {
    ...
    const handleNext = () => {
        ...
        if (currIndex < total - 1) {
            ...
            //TODO: SAVE QUIZATTEMPT HERE.
            setPhase('results');
        }
    }
    const handleRequeue = () => {
        // handle loading generating & passing new props for Requeue button
        //TODO: implement requeue button
    }
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-ow-dark-blue p-6 gap-8">
                ...
                <div className="flex flex-col items-center gap-3 w-full max-w-sm">
                    <button
                        ...
                        className="w-full bg-ow-orange text-ow-dark-blue py-3 rounded font-black uppercase text-sm tracking-widest hover:bg-ow-orange/80 transition-colors cursor-pointer"
                    >
                        Requeue
                    </button>
                    <Link
            ...
            <div className="flex-1 grid grid-cols-3 gap-6 items-stretch">
                ...
                <div className="relative rounded-xl overflow-hidden border border-white/[0.09] bg-ow-blue/3- min-h-[170px]">
                    {question.imageUrl ? (
                        ...
                        <p>
                            place hodor
                            //TODO: implement placeholder image should URL fail
                        </p>
                    )}
                </div>
            </div>
